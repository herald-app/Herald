...
class HeraldAppStage extends Stage {
  constructor(scope, id, props) {
    ...
    // const setupLambda = new SetupLambdaStack(scope, "SetupLambda", {
    //   setupServiceName: setup.stack.instance.serviceName,
    // });
    ...
    const bastionHost = new BastionHostStack(scope, "BastionHost", {
      vpc: vpc.vpc
    })

    //I don't think I need this
    bastionHost.addDependency(fleetServer);
  }
}
