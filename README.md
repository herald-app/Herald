...
Herald is deployed on AWS infrastructure using Cloud Development Kit (CDK). Herald's architecture also requires that the application that will send data into Herald be deployed on AWS infrastructure as well.
