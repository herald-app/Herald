  ...
  constructor(scope, id, props) {
    ...
    const container = taskDef.addContainer(`${props.nodeName}`, {
      ...
      environment: {
        ...
        // FLEET_SERVER_CERT:
        //   "/usr/share/elastic-agent/config/certs/fleet-server/fleet-server.crt",
        // FLEET_SERVER_CERT_KEY:
        //   "/usr/share/elastic-agent/config/certs/fleet-server/fleet-server.key",
        ...
        FLEET_URL: "https://fleetserver.service.local:8220",
      },
      portMapping: [
        {
          containerPort: 8220,
