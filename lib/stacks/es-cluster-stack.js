...
class ESClusterStack extends Stack {
  constructor(scope, id, props) {
    ...
    // this.lb = new elbv2.NetworkLoadBalancer(this, "ESCluster-Lb", {
    //   vpc: props.vpc,
    // });

    // const listener = this.lb.addListener("ESClusterLb-Listener", {
    //   port: 9200,
    ...
    // listener.addTargetGroups("ES-Cluster-Listener-Target-Groups", {
