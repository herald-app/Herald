...
const { ElasticsearchStack } = require("./elasticsearch-nestedstack");
const { SetupLambdaStack } = require("./setup-lambda-nestedstack");
...
class ESClusterStack extends Stack {
  constructor(scope, id, props) {
    ...
    this.es03.addDependency(this.es02);

    const lambda = new SetupLambdaStack(this, "SetupLambdaStack", {
      setupServiceName: props.setupServer.serviceName,
    });
    lambda.addDependency(this.es01);
  }
}
