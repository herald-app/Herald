...
class Elasticsearch extends Construct {
  constructor(scope, id, props) {
    ...
    this.taskDef.addVolume(props.dataVolume);

    const container = this.taskDef.addContainer(`${props.nodeName}`, {
      image: ecs.ContainerImage.fromRegistry(
        "heraldinc/elasticsearch-initialcluster:amd64-latest"
      ),
      memoryLimitMiB: 2048,
      environment: {
    ...
    this.instance.connections.allowFrom(props.bastionSg, ec2.Port.tcp(9200));
