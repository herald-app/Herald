...
class LogstashStack extends Stack {
  constructor(scope, id, props) {
    ...
    // const listenerMain = lb.addListener('Main', { port: 5044 });
    // const listenerSsh = lb.addListener('SSH', { port: 22 });

    // listenerMain.addTargets('Target-Main', {
    //   port: 5044,
    //   protocol: elbv2.Protocol.TCP,
    //   targets: [asg],
    // });
    // listenerSsh.addTargets('Target-SSH', {
    //   port: 22,
    //   targets: [asg],
    // });
