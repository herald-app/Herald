...
const { Code, Function, Runtime } = require("aws-cdk-lib/aws-lambda");
  ...
  constructor(scope, id, props) {
    ...
    const rule = new Rule(this, "Stop Task", {
      eventPattern: {
        ...
        detail: {
          taskDefinitionArn: [this.es02.stack.taskDef.taskDefinitionArn],
          lastStatus: ["PENDING"],
    ...
    const lambdaFn = new Function(this, "Lambda", {
      ...
      code: Code.fromAsset(path.join(__dirname, "../utils/setup-lambda")),
      handler: "index.handler",
    });

    lambdaFn.addPermission("InvokePermission", {
      principal: new iam.ServicePrincipal("events"),
